...
import { Plus, FileText, Banknote, ChevronDown, Loader2, RefreshCw } from 'lucide-react';
import { Dialog } from '@/components/ui/dialog';
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs.jsx";
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from '@/components/ui/dropdown-menu';
import { useAuth } from '@/hooks/useAuth.jsx';
import { useToast } from '@/components/ui/use-toast';
import { getBeneficiaries, getInvoices, addInvoice, deleteInvoice, addVoucher, getVouchers, deleteVoucher, getBankAccountsForBeneficiary } from '@/lib/api';
...
const Finance = ({ organisationBankAccounts, quickAction, clearQuickAction, entityId }) => {
  ...
  const selectedVoucherData = React.useMemo(() => {
    ...
    return { beneficiary, fromAccount, toAccount };
